    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View className="flex-row items-center justify-between mb-4">
            <View className="flex-row items-center">
              ...
              <View>
                ...
                <Text className="text-gray-500 text-sm">{appConfig.welcomeMessage}</Text>
              </View>
            </View>
        ...
        <View className="px-6 py-4">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-xl font-bold text-gray-800">Featured Course</Text>
            <TouchableOpacity>
          ...
          >
            <View className="flex-row items-center justify-between mb-4">
              <View className="bg-purple-400 px-3 py-1 rounded-full">
                <Text className="text-white text-xs font-bold">{featuredCourse.tag}</Text>
              </View>
            ...
            <Text className="text-purple-100 mb-4">{featuredCourse.description}</Text>
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <Text className="text-white font-medium">{featuredCourse.instructor}</Text>
                <View className="flex-row items-center ml-3">
                  <AntDesign name="star" size={14} color="#FCD34D" />
                  <Text className="text-white font-medium ml-1">{featuredCourse.rating}</Text>
                </View>
              </View>
            </View>
            ...
            <View className="flex-row items-center mt-4 space-x-4">
              <View className="flex-row items-center">
                ...
                <Text className="text-white text-sm ml-1">{featuredCourse.lessons} lessons</Text>
              </View>
              <View className="flex-row items-center ml-2">
                <Ionicons name="time-outline" size={14} color="#E0E7FF" />
                <Text className="text-white text-sm ml-1 ">{featuredCourse.duration}</Text>
              </View>
              <TouchableOpacity className="bg-white px-4 py-2 rounded-full ml-auto">
                <Text className="text-purple-600 font-semibold text-sm">Continue</Text>
              </TouchableOpacity>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View className="px-6 py-4 pb-8">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-xl font-bold text-gray-800">Ongoing Courses</Text>
            <TouchableOpacity>
